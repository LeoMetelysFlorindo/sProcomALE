<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ConsAudiencias.aspx.vb" Inherits="AleamRamais.ConsAudiencias" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <td class="style526">
        ...
        <asp:Panel ID="Panel15" runat="server" BorderStyle="None" Width="961px">
            <asp:Label ID="Label2" runat="server" Text="Data Audiência:" 
                BackColor="White" 
                style="font-size: medium; font-weight: 700; font-family: 'Trebuchet MS'; margin-left: 11px;"></asp:Label>
            <asp:TextBox ID="TxtSolicitante" runat="server" Height="23px" Width="182px"></asp:TextBox>
    ...
    <td class="style527">
        ...
        Caption="Reclamantes" SelectedIndex="1" PageSize="20" 
