...
Public Class rptRelAudiencias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AleamRamais.rptRelAudiencias.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DiadaSemana() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptRelAudiencias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRelAudiencias = New rptRelAudiencias()
        rpt.Site = Me.Site
        Return rpt
    End Function
