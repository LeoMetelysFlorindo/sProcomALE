...
Public Class ConsReclamantes
    ...
    Private Sub CarregarGrid(ByVal NomeReclamado As String)
        ...
        strSQL = "SELECT codreclamante, reclamante, rg,cpf, naturalidade  FROM reclamante where reclamante like '" & NomeReclamado.ToUpper() & "' "
    ...
    Private Sub CarregarGridTodos()
        ...
        strSQL = "SELECT codreclamante, reclamante, rg,cpf, naturalidade  FROM reclamante  order by codreclamante"
